...
library AllianceJoinRequest {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "Primodium", name: "AllianceJoinRequ", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x74625072696d6f6469756d0000000000416c6c69616e63654a6f696e52657175);
   ...
   * @notice Get timeStamp.
   */
  function get(bytes32 entity, bytes32 alliance) internal view returns (uint256 timeStamp) {
    bytes32[] memory _keyTuple = new bytes32[](2);
    _keyTuple[0] = entity;
    _keyTuple[1] = alliance;
   ...
   * @notice Get timeStamp.
   */
  function _get(bytes32 entity, bytes32 alliance) internal view returns (uint256 timeStamp) {
    bytes32[] memory _keyTuple = new bytes32[](2);
    _keyTuple[0] = entity;
    _keyTuple[1] = alliance;
   ...
   * @notice Set timeStamp.
   */
  function set(bytes32 entity, bytes32 alliance, uint256 timeStamp) internal {
    bytes32[] memory _keyTuple = new bytes32[](2);
    _keyTuple[0] = entity;
    _keyTuple[1] = alliance;
   ...
   * @notice Set timeStamp.
   */
  function _set(bytes32 entity, bytes32 alliance, uint256 timeStamp) internal {
    bytes32[] memory _keyTuple = new bytes32[](2);
    _keyTuple[0] = entity;
    _keyTuple[1] = alliance;
