...
library AllianceJoinRequest {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "Pri_11", name: "AllianceJoinRequ", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x74625072695f31310000000000000000416c6c69616e63654a6f696e52657175);
