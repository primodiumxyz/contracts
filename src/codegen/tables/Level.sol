...
library Level {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "Primodium", name: "Level", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x74625072696d6f6469756d00000000004c6576656c0000000000000000000000);
