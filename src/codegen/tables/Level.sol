...
library Level {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "Pri_11", name: "Level", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x74625072695f313100000000000000004c6576656c0000000000000000000000);
