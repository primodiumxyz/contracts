...
library P_DestroyedUnits {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "Primodium", name: "P_DestroyedUnits", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x74625072696d6f6469756d0000000000505f44657374726f796564556e697473);
