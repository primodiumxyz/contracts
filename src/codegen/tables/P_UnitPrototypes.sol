...
library P_UnitPrototypes {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "Primodium", name: "P_UnitPrototypes", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x74625072696d6f6469756d0000000000505f556e697450726f746f7479706573);
