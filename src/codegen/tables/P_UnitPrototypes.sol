...
library P_UnitPrototypes {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "Pri_11", name: "P_UnitPrototypes", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x74625072695f31310000000000000000505f556e697450726f746f7479706573);
