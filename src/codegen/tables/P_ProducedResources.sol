...
struct P_ProducedResourcesData {
  uint8[] resources;
  uint256[] amounts;
}

library P_ProducedResources {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "Primodium", name: "P_ProducedResour", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x74625072696d6f6469756d0000000000505f50726f64756365645265736f7572);
  ...
  Schema constant _valueSchema = Schema.wrap(0x0000000262810000000000000000000000000000000000000000000000000000);
   ...
   */
  function get(bytes32 prototype) internal view returns (P_ProducedResourcesData memory _table) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = prototype;
   ...
   * @notice Get the full data.
   */
  function _get(bytes32 prototype) internal view returns (P_ProducedResourcesData memory _table) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = prototype;
   ...
   */
  function set(bytes32 prototype, uint8[] memory resources, uint256[] memory amounts) internal {
   ...
   * @notice Set the full data using individual values.
   */
  function _set(bytes32 prototype, uint8[] memory resources, uint256[] memory amounts) internal {
    bytes memory _staticData;
    EncodedLengths _encodedLengths = encodeLengths(resources, amounts);
    bytes memory _dynamicData = encodeDynamic(resources, amounts);
   ...
   */
  function set(bytes32 prototype, P_ProducedResourcesData memory _table) internal {
    bytes memory _staticData;
   ...
   * @notice Set the full data using the data struct.
   */
  function _set(bytes32 prototype, P_ProducedResourcesData memory _table) internal {
    bytes memory _staticData;
    EncodedLengths _encodedLengths = encodeLengths(_table.resources, _table.amounts);
    bytes memory _dynamicData = encodeDynamic(_table.resources, _table.amounts);
  ...
  ) internal pure returns (P_ProducedResourcesData memory _table) {
