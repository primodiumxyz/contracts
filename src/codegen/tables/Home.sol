...
library Home {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "Primodium", name: "Home", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x74625072696d6f6469756d0000000000486f6d65000000000000000000000000);
