...
library Home {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "Pri_11", name: "Home", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x74625072695f31310000000000000000486f6d65000000000000000000000000);
