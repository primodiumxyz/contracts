...
library Meta_UtilityMap {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "Pri_11", name: "Meta_UtilityMap", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x74625072695f313100000000000000004d6574615f5574696c6974794d617000);
