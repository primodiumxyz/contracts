...
library Keys_UnitFactorySet {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "Pri_11", name: "Keys_UnitFactory", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x74625072695f313100000000000000004b6579735f556e6974466163746f7279);
