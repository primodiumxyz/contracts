...
library P_HasStarmapper {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "Pri_11", name: "P_HasStarmapper", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x74625072695f31310000000000000000505f486173537461726d617070657200);
