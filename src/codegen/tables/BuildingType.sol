...
library BuildingType {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "Pri_11", name: "BuildingType", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x74625072695f313100000000000000004275696c64696e675479706500000000);
