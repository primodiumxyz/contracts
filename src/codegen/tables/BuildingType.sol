...
library BuildingType {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "Primodium", name: "BuildingType", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x74625072696d6f6469756d00000000004275696c64696e675479706500000000);
