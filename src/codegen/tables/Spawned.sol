...
library Spawned {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "Pri_11", name: "Spawned", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x74625072695f31310000000000000000537061776e6564000000000000000000);
