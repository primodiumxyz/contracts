...
library Spawned {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "Primodium", name: "Spawned", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x74625072696d6f6469756d0000000000537061776e6564000000000000000000);
