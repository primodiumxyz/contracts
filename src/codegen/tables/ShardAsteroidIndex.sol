...
library ShardAsteroidIndex {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "Pri_11", name: "ShardAsteroidInd", typeId: RESOURCE_OFFCHAIN_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x6f745072695f31310000000000000000536861726441737465726f6964496e64);
