...
library ClaimOffset {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "Pri_11", name: "ClaimOffset", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x74625072695f31310000000000000000436c61696d4f66667365740000000000);
