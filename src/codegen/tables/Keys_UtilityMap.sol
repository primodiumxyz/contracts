...
library Keys_UtilityMap {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "Primodium", name: "Keys_UtilityMap", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x74625072696d6f6469756d00000000004b6579735f5574696c6974794d617000);
