...
library P_SpawnPirateAsteroid {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "Primodium", name: "P_SpawnPirateAst", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x74625072696d6f6469756d0000000000505f537061776e506972617465417374);

  FieldLayout constant _fieldLayout =
    FieldLayout.wrap(0x0008020404040000000000000000000000000000000000000000000000000000);

  // Hex-encoded key schema of (bytes32)
  Schema constant _keySchema = Schema.wrap(0x002001005f000000000000000000000000000000000000000000000000000000);
  // Hex-encoded value schema of (int32, int32, uint8[], uint256[], bytes32[], uint256[])
  Schema constant _valueSchema = Schema.wrap(0x0008020423236281c18100000000000000000000000000000000000000000000);
  ...
  function set(
    ...
    EncodedLengths _encodedLengths = encodeLengths(resources, resourceAmounts, units, unitAmounts);
